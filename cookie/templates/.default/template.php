...
<div class="cookies" id="cookies" style="background: <?=$arParams['BACKGROUND']?>; color:  <?=$arParams['COLOR']?>;">
    <h4><?=$arParams['NAME']?></h4>
    <div class="cookies__row">
        ...
        <a class="btn_custom close-cookes" style="background: <?=$arParams['BTN_BACKGROUND']?>; color:  <?=$arParams['BTN_COLOR']?>;"><?=$arParams['BUTTON']?></a>
    </div>
</div>
